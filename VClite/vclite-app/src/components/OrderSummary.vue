	...
	<div>
      ...
      <div class="px-3 py-2">
        <b-list-group>
          ...
          <b-list-group-item><p class="billField">ISIN:<span class="spanText">None</span></p></b-list-group-item>
        ...
        <h6 v-if="checked == false">Rs.{{ price*quantity }} + {{ brokerage*100 }}%</h6>
        <h6 v-if="checked == true">Rs.{{ price*quantity }} + {{ iciciBrokerage*100 }}%</h6>
